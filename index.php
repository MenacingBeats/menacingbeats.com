            ...
            <div class="w3-content w3-section">
              ...
              <div class="wrapper">
				...
				<div class="post">
					...
					<div class="tags"><p><small><?php /* Display the tags */ the_tags(); ?></small></p></div>
					
					<p class="artist">Artist Facebook: 
              ...
              <div class="card-group">
                ...
                <div class="card"><a href="sotd.html">
                     <img src="meancingbeats-logo-black-spin.gif" class="card-img-top sotd-gif-card" alt="menacingbeats-sotd-card">
                    <div class="card-body">
